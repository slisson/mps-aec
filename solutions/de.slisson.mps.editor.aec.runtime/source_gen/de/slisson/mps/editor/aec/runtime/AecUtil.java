package de.slisson.mps.editor.aec.runtime;
...
public class AecUtil {
  private static final Logger LOG = Logger.getLogger(AecUtil.class);
  ...
  public static EditorCell createConcreteEditorCell(SNode nodeToEdit, String componentName, EditorContext editorContext) {
    ...
    try {
      ...
      String errorText = "Failed to load concrete component for '" + componentName + "'";
      result = new EditorCell_Error(editorContext, nodeToEdit, errorText);
